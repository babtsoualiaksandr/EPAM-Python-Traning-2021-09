...
def index(request):
    ...
    if request.GET.get("input_string_1"):
        ...
        result_1 = task_1.len_str(input_string_1)  # 
    ...
    if request.GET.get("input_string_2"):
        ...
        result_2 = task_1.count_character_frequency(input_string_2)  # 
    ...
    if request.GET.get("input_string_3"):
        ...
        result_3 = task_1.unique_words_sorted(input_list)  # 
    ...
    if request.GET.get("input_string_33"):
        ...
        result_33 = task_1.get_divisors_number(int(input_string_33))  # 
    ...
    if request.GET.get("input_string_4"):
        ...
        print(dict_input)
        result_4 = task_1.sort_dictionary_by_key(dict_input)  # 
